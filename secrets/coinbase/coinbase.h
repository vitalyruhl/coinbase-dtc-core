...
#ifndef COINBASE_EXCHANGE_SECRETS_H
#define COINBASE_EXCHANGE_SECRETS_H
...
const std::string CDP_JSON_FILE_PATH = "secrets/coinbase/cdp_api_key_ECDSA.json"; // you can download it from Coinbase on API key creation. NOTE You need to change format to ECDSA on creation!
...
#endif // COINBASE_EXCHANGE_SECRETS_H